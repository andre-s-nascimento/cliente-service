...
public class AdminController {
  ...
  @Operation(
      ...
      description =
          "Este endpoint lista todos os clientes cadastrados no sistema. Apenas usuários com o papel 'ADMIN' podem acessar essa informação.")
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Clientes listados com sucesso"),
        @ApiResponse(
            responseCode = "403",
            description = "Acesso não autorizado, necessário papel 'ADMIN'")
      })
  @PreAuthorize("hasRole('ADMIN')")
  @GetMapping("/clientes")
  public ResponseEntity<List<ClienteAdminDTO>> getAllClientes(
      @Parameter(description = "Bearer Token necessário para autenticação", required = true)
